...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white px-6 py-3 flex items-center justify-between mb-6">
            <a href="{{ url('/admin/attendance/staff/' . $user->id . '?month=' . $currentMonth->copy()->subMonth()->format('Y-m')) }}"
            ...
            <a href="{{ url('/admin/attendance/staff/' . $user->id . '?month=' . $currentMonth->copy()->addMonth()->format('Y-m')) }}"
        ...
        <div class="flex justify-end mt-6">
            <a href="{{ url('/admin/attendance/staff/' . $user->id . '/export?month=' . $currentMonth->format('Y-m')) }}"
